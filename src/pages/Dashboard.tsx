      ...
      {!authed && (
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-lg font-medium text-blue-900">欢迎来到知识付费管理系统</h3>
              <p className="text-blue-700 mt-1">请先登录以查看和管理您的学习资源</p>
              <Link
                to="/login"
                className="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200 mt-3"
              >
                立即登录
              </Link>
            </div>
